// netlify/functions/admin-registration-add-payment.js
// 'add-payment' / 'mark-paid' action, split from admin-registration-update.js.
// Adds a manual payment entry to a registration.
//
// POST { id, amount, method, note }
...
export const config = { path: '/.netlify/functions/admin-registration-add-payment' };
