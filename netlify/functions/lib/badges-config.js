...
export const DEFAULT_BADGES = [
  ...
  { kind: 'bestdressed', label: 'Best Dressed',      tone: 'rose',   pri: 25, enabled: true, manual: true,  gendered: false, scopes: ['weekly', 'season'] },
  { kind: 'streak5',     label: '5+ Win Streak',     tone: 'teal',   pri: 20, enabled: true, manual: false, gendered: false, scopes: [] },
];

const TONES = new Set(['gold', 'teal', 'lime', 'violet', 'rose']);
