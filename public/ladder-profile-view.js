...
(function () {
  ...
  window.ladderProfileBody = function (L) {
    ...
    h += '<div style="display:grid;grid-template-columns:repeat(4,1fr);gap:6px">' + kc(L.w + '-' + L.l, 'Record') + kc((L.winPct != null ? L.winPct : 0) + '%', 'Win%', LIME) + kc((L.ladders != null ? L.ladders : (L.nights != null ? L.nights : '—')), 'Ladders') + kc(rankVal, 'Rank', L.rank ? null : FA) + '</div>';
